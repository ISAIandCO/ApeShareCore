...
- Выключенные и неприменимые к ОС категории скрыты в графе. Незавершённые профили явно помечаются в редакторе и не включаются до заполнения обязательных полей; ошибки называют профиль.
